...
public class GroeneStroomCertificaatControllerTest {
    ...
    public void findAllShouldFetchAHalDocument() throws Exception {
        ...
        mvc.perform(get("/v1/certificates/83020711970")
                ...
                .andExpect(jsonPath("$._embedded.certificaten[0].id", is(1)))
                .andExpect(jsonPath("$._embedded.certificaten[0].year", is("2019")))
                .andExpect(jsonPath("$._embedded.certificaten[0].language", is("nl")))
                .andExpect(jsonPath("$._embedded.certificaten[0].name", is("Groene stroom certificaat 2019")))
                .andExpect(jsonPath("$._embedded.certificaten[0]._links.self.href", is("http://localhost/v1/certificates/83020711970/1")))

                .andExpect(jsonPath("$._embedded.certificaten[1].id", is(2)))
                .andExpect(jsonPath("$._embedded.certificaten[1].year", is("2018")))
                .andExpect(jsonPath("$._embedded.certificaten[1].language", is("nl")))
                .andExpect(jsonPath("$._embedded.certificaten[1].name", is("Groene stroom certificaat 2018")))
                .andExpect(jsonPath("$._embedded.certificaten[1]._links.self.href", is("http://localhost/v1/certificates/83020711970/2")))
